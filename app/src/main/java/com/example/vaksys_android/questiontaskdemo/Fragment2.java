...
public class Fragment2 extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        q1b1 = (Button)view.findViewById(R.id.q2b1);
        q1b1.setOnClickListener(this);

        q1b2 = (Button) view.findViewById(R.id.q2b2);
        q1b2.setOnClickListener(this);

        q1b3 = (Button) view.findViewById(R.id.q2b3);
        q1b3.setOnClickListener(this);

        q1b4 = (Button) view.findViewById(R.id.q2b4);
