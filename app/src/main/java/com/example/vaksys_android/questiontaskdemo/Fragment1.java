...
public class Fragment1 extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_1,container,false);
         ...
         q1b1 = (Button)view.findViewById(R.id.q1b1);
        q1b1.setOnClickListener(this);

        q1b2 = (Button) view.findViewById(R.id.q1b2);
        q1b2.setOnClickListener(this);

         q1b3 = (Button) view.findViewById(R.id.q1b3);
        q1b3.setOnClickListener(this);

         q1b4 = (Button) view.findViewById(R.id.q1b4);
