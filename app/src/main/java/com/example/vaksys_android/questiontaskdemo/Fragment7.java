...
public class Fragment7 extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_7,container,false);

         q1b1 = (Button)view.findViewById(R.id.q7b1);
        q1b1.setOnClickListener(this);

        q1b2 = (Button) view.findViewById(R.id.q7b2);
        q1b2.setOnClickListener(this);

         q1b3 = (Button) view.findViewById(R.id.q7b3);
        q1b3.setOnClickListener(this);

         q1b4 = (Button) view.findViewById(R.id.q7b4);
    ...
    public void callF7() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                Fragment8 fragment7 = new Fragment8();
                android.app.FragmentManager fragmentManager = getFragmentManager();
                android.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.add(R.id.main_frame,fragment7);
