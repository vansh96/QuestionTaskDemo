...
public class Fragment5 extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_5,container,false);
         ...
         q1b1 = (Button)view.findViewById(R.id.q5b1);
        q1b1.setOnClickListener(this);

        q1b2 = (Button) view.findViewById(R.id.q5b2);
        q1b2.setOnClickListener(this);

         q1b3 = (Button) view.findViewById(R.id.q5b3);
        q1b3.setOnClickListener(this);

         q1b4 = (Button) view.findViewById(R.id.q5b4);
    ...
    public void callF5() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                Fragment6 fragment5 = new Fragment6();
                android.app.FragmentManager fragmentManager = getFragmentManager();
                android.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.add(R.id.main_frame,fragment5);
