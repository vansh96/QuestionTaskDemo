...
public class Fragment6 extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_6,container,false);
         ...
         q1b1 = (Button)view.findViewById(R.id.q6b1);
        q1b1.setOnClickListener(this);

        q1b2 = (Button) view.findViewById(R.id.q6b2);
        q1b2.setOnClickListener(this);

         q1b3 = (Button) view.findViewById(R.id.q6b3);
        q1b3.setOnClickListener(this);

         q1b4 = (Button) view.findViewById(R.id.q6b4);
    ...
    public void callF6() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                Fragment7 fragment6 = new Fragment7();
                android.app.FragmentManager fragmentManager = getFragmentManager();
                android.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.add(R.id.main_frame,fragment6);
